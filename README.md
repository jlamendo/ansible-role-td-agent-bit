...
#### flb_conf_dir
- Description: The location where td-agent-bit configuration files are stored. Changing this value may require you to modify the init script created by your systems package manager when td-agent-bit is installed. Leave it set to the default unless your environment mandates that you change it.
- Default: `flb_conf_dir: "/etc/td-agent-bit"`

#### flb_conf_file
- Description: The location where the main td-agent-bit configuration file is stored. Changing this value may require you to modify the init script created by your systems package manager when td-agent-bit is installed. Leave it set to the default unless your environment mandates that you change it.
- Default: `flb_conf_file: "td-agent-bit.conf"`

#### flb_binary
- Description: The location of the td-agent-bit binary. This variable is only used as a fallback when the role is unable to detect the location of the binary via `which`.
- Default: `flb_binary: "/usr/local/bin/td-agent-bit"`
